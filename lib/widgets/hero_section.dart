    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          colors: [
            Color(0xFF19173D), // Base color (new darker tone)
            Color(0xFF22205A), // Intermediate dark tone
            Color(0xFF2D2A6F), // Lighter end tone of the new range
            Color(0xFF5C6BC0), // Existing soft blue for contrast
            Color(0xFF1A73E8), // Accent vibrant blue for a modern look
          ],
